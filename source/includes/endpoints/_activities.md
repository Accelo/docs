...
| **against_type** | The object the activity is linked against. This can be: activity_event, asset, affiliation, annex, account_invoice, account_purchase, contact, contract, contract_period, company, deployment, issue, job, milestone, prospect, request, staff or task.  |
